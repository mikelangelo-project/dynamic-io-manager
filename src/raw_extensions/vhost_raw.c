...
static PyMemberDef VhostVirtqueue_members[] = {
    ...
    VHOST_VQ_STAT(handled_bytes, "bytes sent/received"),
    VHOST_VQ_STAT(handled_packets, "packets sent/received"),
    ...
    VHOST_VQ_STAT(handled_bytes_this_work, "number of bytes handled by this queue in the last poll/notif. Must be updated by the concrete vhost implementations (vhost-net)"),
